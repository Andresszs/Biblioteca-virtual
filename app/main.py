...
from app.routers.usuarios.registro import router as registro_router
from app.routers.usuarios.login import router as login_router
from app.routers.usuarios.pago import router as pago_router
from app.routers.usuarios.historial import router as historial_router
from app.routers.usuarios.detalle import router as detalle_router
from app.routers.usuarios.cupon import router as cupon_router
from app.routers.usuarios.resena import router as resena_router
from app.routers.usuarios.ver_resenas import router as ver_resenas_router
...
app.include_router(registro_router)              # HU09
app.include_router(login_router)              # HU10
app.include_router(pago_router)             # HU11
app.include_router(historial_router)         # HU12
app.include_router(detalle_router)        # HU13
app.include_router(cupon_router)     # HU14
app.include_router(resena_router)   # HU15 
app.include_router(ver_resenas_router)  # HU16
